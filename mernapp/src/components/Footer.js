    ...
    <div className="footer">
      ...
      <div className="footer-two">
        <div className="two-one">
          <span className="header-option">Get to Know Us</span>
          <ul>
            <li>
        ...
        <div className="two-one">
          <span className="header-option">Connect with Us</span>
          <ul>
            <li>
        ...
        <div className="two-one">
          <span className="header-option">Make Money with Us</span>
          <ul>
            <li>
        ...
        <div className="two-one">
          <span className="header-option">Let Us Help You</span>
          <ul>
            <li>
            ...
            <li>
              <a href="https://www.amazon.in/gp/css/homepage.html?ref_=footer_ya">
                Your Account
              </a>
            </li>
            <li>
